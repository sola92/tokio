// flow-typed signature: 3206fb6e684129f708866e792ee2c58a
// flow-typed version: <<STUB>>/aws-sdk_v^2.307.0/flow_v0.79.1
...
declare module "aws-sdk" {
  declare export type SqsCallbackFn<R> = (error: ?Error, data: R) => void;

  declare export type Sqs$QueueAttributName =
    | "All"
    | "Policy"
    | "VisibilityTimeout"
    | "MaximumMessageSize"
  ...
  declare export type Sqs$Message = {
    MessageId: string,
    ...
    MessageAttributes: { DataType: string } & $Shape<{
      StringValue: string,
      BinaryValue: any,
  ...
  declare export type Sqs$Response = {
    Messages: Array<Sqs$Message>
  };

  declare export type AWS$Response<T> = {
    data: T,
    error: ?{ code: string, message: string },
    requestId: string
  };

  declare export type Sqs$Client = {
    receiveMessage(
      params: $Shape<{
        QueueUrl: string,
        AttributeNames: Array<Sqs$QueueAttributName>,
        MaxNumberOfMessages: number,
        VisibilityTimeout: number,
        WaitTimeSeconds: number,
        ReceiveRequestAttemptId: string
      }>,
      callback: SqsCallbackFn<Sqs$Response>
    ): AWS$Response<Json>,
    deleteMessage(
      params: {
        QueueUrl: string,
    ...
    sendMessage(
      params: $Shape<{
        ...
        MessageAttributes: { DataType: String } & $Shape<{
          StringValue: string,
          BinaryValue: any,
          StringListValues: Array<any>,
          BinaryListValues: Array<any>
        }>,
        MessageDeduplicationId: string,
        MessageGroupId: string
      }>,
      callback: SqsCallbackFn<{
  ...
  declare export type SQS = {
    client: Sqs$Client
  };

  declare export type AWS = {
    SQS: Class<SQS>,
    config: {
      loadFromPath: (config: Json) => void
    }
  };

  declare module.exports: AWS;
}
